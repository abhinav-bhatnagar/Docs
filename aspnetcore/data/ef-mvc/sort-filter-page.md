...
This code could get verbose with a large number of columns. [The last tutorial in this series](advanced.md#expression-trees) shows how you can use expression trees to write code that lets you pass the name of the column to sort in a string variable.
